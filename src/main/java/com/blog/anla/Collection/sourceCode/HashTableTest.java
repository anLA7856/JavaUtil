...
/**
 * 键值对，key和value都不能为null。
 * 
 * 注意必须重写hashCode以及equals方法
 * 
 * 如果Hashtable在迭代器创建之后的任何时间被结构地修改，
 * 除了通过迭代器自己的 remove方法，迭代器会抛出一个
 ...
 * 建议使用 HashMap代替Hashtable。如果需要线程安全高度并发的实现，
 * 那么建议使用它来ConcurrentHashMap代替 Hashtable。
 *
