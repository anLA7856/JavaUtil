...
public final class Unsafe {
	 ...
	 *             
	 *             
	 * @description 获取o的偏移地址为offset的int值。
	 */
	 ...
	 *             {@link NullPointerException}
	 *             
	 * @description 在o的偏移地址为offset处存储x。
	 */
	 ...
	 * 
	 * @description 获取o的偏移地址为offset的Object类型的引用的值。
	 */
	 ...
	 * @see #allocateMemory
	 * 
	 * @description 从特定内存地址里面获得byte值，没有则为undefined
	 */
	 ...
	 * @see #getByte(long)
	 * 
	 * @description 把byte x的值放入到address处内存地址。
	 */
	 ...
	 * 
	 * @see #allocateMemory
	 * @description 从已经给的一个内存地址中获取本地指针地址。
	 */
	 ...
	 * @see #getAddress(long)
	 * 
	 * @description 把一个本地指针值x存储到内存地址address处。
	 */
	 ...
	 * @see #allocateMemory
	 * 
	 * @description 为内存地址为address的空间重新分配大小为bytes的地址。
	 */
	 ...
	 * @since 1.7
	 * 
	 * @description 把o的偏移地址为offset的值处内存，分配bytes大小内存空间，并设值为value。
	 */
	 ...
	 * 
	 * @description 把绝对地址为offset的值处内存，分配bytes大小内存空间，并设值为value
	 */
	 ...
	 * @since 1.7
	 * 
	 * @description 将源object的srcoffset偏移地址处的bytes大小内存，放入destBase偏移地址
	 */
	 ...
	 *         no effect
	 *         
	 * @description 检测，当前class c是否应该被初始化，
	 */
	 ...
	 * 
	 * @description 保证当前class c 已经被初始化了。
	 */
	 ...
	 * 
	 * @description 返回arrayClass类第一个字节的地址。
	 */
	 ...
	 * @see #putInt(Object, long, int)
	 * 
	 * @description 返回数组元素的大小，注意byte类型获取则为0
	 */
	 ...
	 * 
	 * @description 给cls类分配一个实例内存地址，而不掉用构造器
	 */
	 ...
	 * @description 抛出错误。并不会通知verifier
	 * */
	 ...
	 * 
	 * @description 在o的offset偏移地址处，获取volatile类型的对象
	 */
	 ...
	 *         
	 * @description 根据给定的nelem，即loadavg查询系统负载。
	 */
